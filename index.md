...
## Актуальное состояние удаленного репозитория

Чтобы выкачать актуальное состояние из удаленного репозитория, нужно ввести команду
```
   git pull
```
...
Для отправки запроса на вливание изменений в репозиторий нужно сделать команду *pull request* на GitHub